...
class DatabaseService:
    ...
    async def save_conversation_context(
        ...
        async with self.async_session() as session:
            ...
            if context:
                ...
                context.collected_answers = (
                    json.dumps(collected_answers) if collected_answers else None
                )
    ...
    async def save_user_preference(
        self, session_id: str, insurance_type: str, requirements: Dict[str, Any]
    ) -> UserPreference:
    ...
    async def get_user_preferences(
        self, session_id: str, insurance_type: Optional[str] = None
    ) -> List[UserPreference]:
    ...
    async def get_recommendation_history(
        self, session_id: str, insurance_type: Optional[str] = None, limit: int = 10
    ) -> List[Recommendation]:
    ...
    async def update_recommendation_feedback(
        self, recommendation_id: int, feedback: str, notes: Optional[str] = None
